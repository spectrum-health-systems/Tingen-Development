...
This class is only used to test documentation tags.

It's a copy/paste of this:

https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/xmldoc/examples

It is not part of the Tingen web service, and will eventually be removed.
...
{
    public class DocumentationTesting
    {
        /// <summary>
